...
class LeaderMBF:
    ...
    def is_goal_reached(self, x, y, yaw, pos_tolerance=0.5, yaw_tolerance=radians(360)):
    ...
    def send_goal(self, x, y, yaw_degrees=0, pos_tolerance=0.5, yaw_tolerance=radians(360)):
