...
class LeaderMBF:
    ...
    def send_goal(self, x, y, yaw_degrees=0, pos_tolerance=1, yaw_tolerance=radians(10)):  ############## forse problema di rendere coerente?
        goal = MoveBaseGoal()
        
        # Usa Pose direttamente (senza header)
        ...
        goal.target_pose.orientation.x = quat[0]
        goal.target_pose.orientation.y = quat[1]
        goal.target_pose.orientation.z = quat[2]
        goal.target_pose.orientation.w = quat[3]
...
if __name__ == '__main__':
    leader = LeaderMBF()
    # leader.send_goal(42.0, 42.0, yaw_degrees=10, pos_tolerance=1, yaw_tolerance=radians(45)) #prima era yaw_tolerance=radians(10)
    
    leader.send_goal(x=36.0, y=42.0, yaw_degrees=0, pos_tolerance=1, yaw_tolerance=radians(180))
    #leader.send_goal(x=38.0, y=44.0, yaw_degrees=0, pos_tolerance=1, yaw_tolerance=pi)
